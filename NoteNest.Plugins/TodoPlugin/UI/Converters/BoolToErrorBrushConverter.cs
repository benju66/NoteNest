    ...
    public class BoolToErrorBrushConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is bool isError && isError)
            {
                ...
                return Application.Current.TryFindResource("SystemControlErrorTextForegroundBrush") 
                    ?? new SolidColorBrush(Colors.Red);
            }
            
            // Return default foreground brush
            return Application.Current.TryFindResource("SystemControlForegroundBaseHighBrush") 
