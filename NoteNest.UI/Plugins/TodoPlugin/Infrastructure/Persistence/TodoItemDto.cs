    ...
    public class TodoItemDto
    {
        ...
        public static TodoItemDto FromAggregate(TodoAggregate aggregate)
        {
            return new TodoItemDto
            {
                ...
                CompletedDate = aggregate.CompletedDate?.ToUnixTimeSeconds(),
                DueDate = aggregate.DueDate?.Value.ToUnixTimeSeconds(),
                ReminderDate = aggregate.ReminderDate?.ToUnixTimeSeconds(),
