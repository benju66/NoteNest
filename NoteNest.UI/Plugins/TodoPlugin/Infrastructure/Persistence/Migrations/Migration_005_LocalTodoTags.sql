...
-- ============================================================================
-- Purpose: Keep todo tags in todos.db where they belong
-- This respects the architecture where todos.db is permanent and tree.db is rebuildable
-- ============================================================================

PRAGMA foreign_keys = OFF;

-- Create new todo_tags table with enhanced structure
...
VALUES (5, strftime('%s', 'now'), 'Local todo tags with display names - respecting database isolation');
